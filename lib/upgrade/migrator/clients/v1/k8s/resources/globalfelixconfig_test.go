...
import (
	...
	"github.com/unai-ttxu/libcalico-go/lib/upgrade/migrator/clients/v1/k8s/custom"
	"github.com/unai-ttxu/libcalico-go/lib/upgrade/migrator/clients/v1/k8s/resources"
